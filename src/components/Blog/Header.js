    ...
    return (
      <header className="page-header">
        ...
        <div className="rd-navbar-wrap">
          <nav
            className="rd-navbar rd-navbar-classic rd-navbar-classic-minimal"
          ...
          >
            <div className="rd-navbar-inner">
              ...
              <div className="rd-navbar-right-side">
                ...
                {}
                <button
                  className="rd-navbar-info-toggle d-inline-block"
                  data-rd-navbar-toggle=".rd-navbar-search-wrap-info"
                />
